...
PlayerOne.hp = 100;
PlayerOne.minAtk = 200;
PlayerOne.maxAtk = 500;
  ...
  this.setLairTitle = function(lair){
    switch (lair) {
      case 1:
        ...
        $('#creatureBtn').click(function(){
          $('.first-level').append('<p id="bing">');
          $('#bing').html('bing');
        });
        break;
      // case 2:
...
// console.log(PlayerOne.atkPower);
// console.log(PlayerTwo.hp);
// console.log(PlayerTwo.atkPower);
// console.log(creature.manaDrop);
...
$(document).ready(function(){
  ...
  $('#hello_btn').click(function(){
    ...
    //$('.first-level').html(theGrave.getLairs(1));
    //startMenu.start = true;
